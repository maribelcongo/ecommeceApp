...
const Cart = () => {
  const { cart, removeFromCart, updateQuantity } = useCart(); // Asegúrate de que `updateQuantity` esté en tu contexto de carrito
  ...
  return (
    ...
    >
          ...
          >
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              <IconButton
                ...
                disabled={item.quantity <= 1} // No permitir reducir a 0
                sx={{
                  color: "#c55e82",
                  "&:hover": { color: "#b04a6e" },
                }}
      ...
      <Button
        ...
        component={Link}
        to="/checkout"
        disabled={cart.length === 0} // Deshabilita el botón si el carrito está vacío
      >
        Finalizar compra
      </Button>
    </Box>
